    ...
    <Section ref={sectionRef} id="testimonials">
      <div className="mb-10 md:mb-12 flex flex-col items-center">
        <h2 className={`${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          See Why New Patients Keep Recommending Us
        </h2>
        <p
        ...
        >
          From gentle care to amazing results, here’s what our patients have to
          say.
        </p>
      </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* Navigation Controls */}
        <div className="flex items-center justify-between mt-6 md:mt-8 xl:hidden">
          {/* Pagination Bullets */}
